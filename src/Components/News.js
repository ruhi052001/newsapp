...
export class News extends Component {
  articles=[
    {
        ...
        "description": "<p>The third Test between India and Australia is at risk of being moved to a different venue at the eleventh hour, with Dharamsala&rsquo;s Himachal Pradesh Cricket Association Stadium reportedly not fit to host international cricket.</p>",
  ...
  async componentDidMount(){
    let url="https://newsapi.org/v2/top-headlines?country=in&apiKey=fe7bc2235a324c0e97b6e763ab6b6341";
